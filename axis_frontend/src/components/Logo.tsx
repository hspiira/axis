  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <div className={`${sizes[size]} shrink-0`}>
        <Bao className="w-full h-full" />
      </div>
      {showText && (
        <span className={`font-semibold text-white ${textSizes[size]}`}>Bao</span>
      )}
    </div>
  )
}
